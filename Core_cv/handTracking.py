...
def run_vision(target_queue, result_queue):
    ...
    aslDict = {"A": {
            ...
            4:  {'x': 1.198, 'y': -1.465, 'z': -0.290}, # Thumb
            8:  {'x': 1.583, 'y': -1.275, 'z': -0.588}, # Index
            12: {'x': 0.856, 'y': -0.724, 'z': -0.486}, # Middle
            16: {'x': 0.817, 'y': -0.396, 'z': -0.379}, # Ring
            20: {'x': 0.795, 'y': -0.088, 'z': -0.468}  # Pinky
        }, "H": {
            4:  {'x': 1.134, 'y': -0.548, 'z': 0.198}, # Thumb
            8:  {'x': 1.732, 'y': -0.767, 'z': 0.024}, # Index
            12: {'x': 1.869, 'y': -0.553, 'z': -0.037}, # Middle
            16: {'x': 0.985, 'y': -0.228, 'z': 0.046}, # Ring
            20: {'x': 0.923, 'y': 0.016, 'z': 0.093}  # Pinky
        }, "I": {
            4:  {'x': 0.191, 'y': -1.146, 'z': -0.222}, # Thumb
            8:  {'x': 0.340, 'y': -0.866, 'z': -0.218}, # Index
            12: {'x': 0.198, 'y': -0.748, 'z': -0.225}, # Middle
            16: {'x': 0.057, 'y': -0.621, 'z': -0.166}, # Ring
            20: {'x': -0.155, 'y': -1.611, 'z': -0.125} # Pinky
        }, "K": {
            4:  {'x': 0.375, 'y': -1.276, 'z': -0.010}, # Thumb
            8:  {'x': 0.475, 'y': -2.175, 'z': -0.297}, # Index
            12: {'x': 0.888, 'y': -1.926, 'z': -0.282}, # Middle
            16: {'x': 0.481, 'y': -0.915, 'z': -0.106}, # Ring
            20: {'x': 0.561, 'y': -0.682, 'z': -0.043}  # Pinky
        }, "L": {
            4:  {'x': 0.991, 'y': -0.523, 'z': -0.380}, # Thumb
            8:  {'x': 0.463, 'y': -1.865, 'z': -0.339}, # Index
            12: {'x': 0.258, 'y': -0.485, 'z': -0.266}, # Middle
            16: {'x': 0.098, 'y': -0.457, 'z': -0.198}, # Ring
            20: {'x': -0.046, 'y': -0.506, 'z': -0.165} # Pinky
        }, "M": {
            4:  {'x': 0.018, 'y': -0.984, 'z': -0.301}, # Thumb
            8:  {'x': 0.407, 'y': -0.482, 'z': -0.423}, # Index
            12: {'x': 0.288, 'y': -0.499, 'z': -0.318}, # Middle
            16: {'x': 0.106, 'y': -0.597, 'z': -0.210}, # Ring
            20: {'x': -0.138, 'y': -0.589, 'z': -0.237} # Pinky
        }, "N": {
            4:  {'x': 0.070, 'y': -1.130, 'z': -0.215}, # Thumb
            8:  {'x': 0.365, 'y': -0.660, 'z': -0.330}, # Index
            12: {'x': 0.250, 'y': -0.710, 'z': -0.265}, # Middle
            16: {'x': 0.095, 'y': -0.510, 'z': -0.185}, # Ring
            20: {'x': -0.040, 'y': -0.520, 'z': -0.170} # Pinky
        }, "O": {
            4:  {'x': 0.741, 'y': -0.753, 'z': 0.078}, # Thumb
            8:  {'x': 0.661, 'y': -0.990, 'z': 0.105}, # Index
            12: {'x': 0.674, 'y': -0.995, 'z': 0.005}, # Middle
            16: {'x': 0.661, 'y': -0.935, 'z': -0.088}, # Ring
            20: {'x': 0.598, 'y': -0.865, 'z': -0.158}  # Pinky
        }, "P": {
            4:  {'x': 0.771, 'y': -0.730, 'z': -0.345}, # Thumb
            8:  {'x': 1.150, 'y': -0.801, 'z': -0.575}, # Index
            12: {'x': 0.950, 'y': -0.098, 'z': -0.505}, # Middle
            16: {'x': 0.405, 'y': -0.125, 'z': -0.325}, # Ring
            20: {'x': 0.355, 'y': -0.055, 'z': -0.470}  # Pinky
        }, "Q": {
            4:  {'x': 1.125, 'y': -0.320, 'z': -0.125}, # Thumb
            8:  {'x': 1.285, 'y': -0.560, 'z': -0.230}, # Index
            12: {'x': 0.665, 'y': -0.340, 'z': -0.270}, # Middle
            16: {'x': 0.580, 'y': -0.220, 'z': -0.230}, # Ring
            20: {'x': 0.535, 'y': -0.140, 'z': -0.295}  # Pinky
        }, "R": {
            4:  {'x': 0.193, 'y': -0.895, 'z': -0.332}, # Thumb
            8:  {'x': 0.191, 'y': -1.716, 'z': -0.336}, # Index
            12: {'x': 0.174, 'y': -1.920, 'z': -0.338}, # Middle
            16: {'x': 0.106, 'y': -0.609, 'z': -0.298}, # Ring
            20: {'x': 0.006, 'y': -0.486, 'z': -0.294}  # Pinky
        }, "S": {
            4:  {'x': 0.432, 'y': -1.055, 'z': -0.225}, # Thumb
            8:  {'x': 0.315, 'y': -0.785, 'z': -0.160}, # Index
            12: {'x': 0.155, 'y': -0.772, 'z': -0.036}, # Middle
            16: {'x': 0.016, 'y': -0.760, 'z': 0.040},  # Ring
            20: {'x': -0.110, 'y': -0.810, 'z': 0.018}  # Pinky
        }, "T": {
            4:  {'x': 0.457, 'y': -1.144, 'z': -0.155}, # Thumb
            8:  {'x': 0.443, 'y': -0.771, 'z': -0.264}, # Index
            12: {'x': 0.229, 'y': -0.457, 'z': -0.203}, # Middle
            16: {'x': 0.081, 'y': -0.392, 'z': -0.123}, # Ring
            20: {'x': -0.035, 'y': -0.521, 'z': -0.117} # Pinky
        }, "U": {
            4:  {'x': 0.111, 'y': -0.672, 'z': -0.395}, # Thumb
            8:  {'x': 0.434, 'y': -1.803, 'z': -0.396}, # Index
            12: {'x': 0.350, 'y': -1.990, 'z': -0.423}, # Middle
            16: {'x': 0.108, 'y': -0.513, 'z': -0.399}, # Ring
            20: {'x': 0.027, 'y': -0.427, 'z': -0.356}  # Pinky
        }, "V": {
            4:  {'x': 0.007, 'y': -0.826, 'z': -0.366}, # Thumb
            8:  {'x': 0.274, 'y': -1.869, 'z': -0.334}, # Index
            12: {'x': -0.264, 'y': -1.839, 'z': -0.355}, # Middle
            16: {'x': 0.008, 'y': -0.523, 'z': -0.309}, # Ring
            20: {'x': -0.076, 'y': -0.380, 'z': -0.294} # Pinky
        }, "W": {
            4:  {'x': 0.046, 'y': -0.588, 'z': -0.347}, # Thumb
            8:  {'x': 0.606, 'y': -1.755, 'z': -0.367}, # Index
            12: {'x': 0.174, 'y': -2.007, 'z': -0.400}, # Middle
            16: {'x': -0.201, 'y': -1.716, 'z': -0.521},# Ring
            20: {'x': -0.041, 'y': -0.496, 'z': -0.419} # Pinky
        }, "X": {
            4:  {'x': 0.366, 'y': -0.669, 'z': -0.524}, # Thumb
            8:  {'x': 0.603, 'y': -1.364, 'z': -0.421}, # Index
            12: {'x': 0.316, 'y': -0.622, 'z': -0.198}, # Middle
            16: {'x': 0.124, 'y': -0.650, 'z': -0.101}, # Ring
            20: {'x': -0.038, 'y': -0.733, 'z': -0.169} # Pinky
        }, "Y": {
            4:  {'x': 0.571, 'y': -1.315, 'z': -0.198}, # Thumb
            8:  {'x': 0.183, 'y': -0.662, 'z': -0.238}, # Index
            12: {'x': 0.081, 'y': -0.476, 'z': -0.266}, # Middle
            16: {'x': -0.071, 'y': -0.497, 'z': -0.196}, # Ring
            20: {'x': -0.789, 'y': -1.418, 'z': -0.217} # Pinky
        }
    }
    ...
    def checkSign (asl_sign, current_rel_tips, hand):
        ...
        error_threshold = 2  # may need to adjust this based on testing
    ...
    with HandLandmarker.create_from_options(options) as landmarker:
        ...
        while cap.isOpened():
            ...
            if result.hand_landmarks and target_sign is not None:
