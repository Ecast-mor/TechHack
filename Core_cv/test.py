...
aslDict = {"A": {
            ...
            "error_threshold": 1.0  ### FIX THIS BASED ON TESTING 
        }, "E": {
            ...
            'error_threshold': 2.0   ## FIX THIS BASED ON TESTING
        }, "H": {
            ...
            "error_threshold": 1.4 # rerecord this and adjust based on testing
        }, "L": {
...
def checkSign (current_rel_tips, hand):
        target_sign = "Y"
        ...
        error_threshold = aslDict[target_sign]["error_threshold"]  # may need to adjust this based on testing

        if total_error < error_threshold:
            print(f"Detected sign: {target_sign} with error: {total_error:.4f}")
        else:
            print(f"Sign {target_sign} not detected. Total error: {total_error:.4f}")
        ...
        while cap.isOpened():   
            ...
            if result.hand_landmarks:
                for i, hand in enumerate(result.hand_landmarks):
                    ...
                    checkSign(current_rel_tips, hand)             
